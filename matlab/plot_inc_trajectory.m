...
rsults_folder = 'Tal_Regev/anpl_mr_passive_rosbag_Tal_Regev_2018-12-31_10-39-02';
...
if draw_map
    ...
    path_to_bag = [getenv('HOME') filesep 'ANPL' filesep 'infrastructure' filesep 'mrbsp_ws' filesep 'src' ...
        filesep 'open_mrbsp' filesep 'scenarios' filesep scenario ...
