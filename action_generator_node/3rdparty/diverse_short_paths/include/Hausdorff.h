...
/**
 * Container for the discrete Hausdorff distance algorithm.
 */
class Hausdorff : public PathDistanceMeasure
{
public:
    ...
    /**
     * Compute the distance between two paths according to the discrete Hausdorff algorithm.
