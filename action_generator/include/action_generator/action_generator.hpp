...
#ifndef ACTION_GENERATOR_ACTION_GENERATOR_H
#define ACTION_GENERATOR_ACTION_GENERATOR_H
...
public:
	...
	void initializeMarkers() {
        ...
        m_vis_start_goal.mesh_resource = "package://action_generator/meshes/start.stl";
	...
	mrbsp_msgs::Actions loadActionsFromFile(std::string filename) {
		return mrbsp_msgs::Actions();
	}
...
protected:
	...
	bool generateActionsInteractive(mrbsp_msgs::GenerateActions::Request& req, mrbsp_msgs::GenerateActions::Response& res)
	{
    ...
    bool generateActionsOMPL(mrbsp_msgs::GenerateActions::Request& req, mrbsp_msgs::GenerateActions::Response& res)
    {
        ...
        m_vis_start_goal.mesh_resource = "package://action_generator/meshes/goal.stl";
...
#endif //ACTION_GENERATOR_ACTION_GENERATOR_H
